...
## Recent Changes
- 2026-03-04: Moved Batch Trader to separate page (/batch-trader route) with dedicated header navigation button. Removed from tab bar. Route defined in App.tsx, nav button in header toggles between Bot Builder and Batch Trader pages. Full-page layout with navy blue nav button styling.
