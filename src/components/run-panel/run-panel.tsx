...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, CHART, SMART_TRADER, BATCH_TRADER } = DBOT_TABS;
    ...
    const show_run_panel = [BOT_BUILDER, CHART, SMART_TRADER, BATCH_TRADER].includes(active_tab) || active_tour;
